...
@section('content')
        ...
        {!! Form:: open(['route' => ['admin.menus.update',$menus], 'method' => 'PUT']) !!}
            <div class="form-group">
              {!!Form::label('name', 'Nombre')!!}
              {!!Form::text('name', $menus->name, ['class'=>'form-control','placeholder'=>'Nombre del Menú','required'])!!}
              <br>
            </div>
            <div class="form-group">
