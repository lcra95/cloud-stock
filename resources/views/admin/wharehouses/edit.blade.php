...
@section('title')
Editar Almacén {{$wharehouses->name}}
@endsection
@section('nuevo')
...
@section('content')
        ...
        {!! Form:: open(['route' => ['admin.wharehouses.update',$wharehouses], 'method' => 'PUT']) !!}
            <div class="form-group">
              {!!Form::label('name', 'Nombre')!!}
              {!!Form::text('name', $wharehouses->name, ['class'=>'form-control','placeholder'=>'Nombre del Menú','required'])!!}
